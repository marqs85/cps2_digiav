...
BOOL EnableAudioOutputHDMI(ULONG VideoPixelClock)
{
    ...
    HDMITX_WriteI2C_Byte(REGPktAudN2,(BYTE)((n>>16)&0xF)) ;
    //program CTS
    HDMITX_WriteI2C_Byte(REGPktAudCTS0,(VideoPixelClock/1000) & 0xff);
    HDMITX_WriteI2C_Byte(REGPktAudCTS1,((VideoPixelClock/1000)>>8) & 0xff) ;
    ...
    HDMITX_WriteI2C_Byte(REG_TX_AUDCHST_CAT,2);
