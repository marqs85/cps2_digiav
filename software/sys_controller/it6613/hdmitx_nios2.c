...
alt_u32 read_it2(alt_u32 regaddr) {
	...
	I2C_write(I2C_OPENCORES_0_BASE, regaddr, 0);
	I2C_start(I2C_OPENCORES_0_BASE, IT_BASE, 1);
	return I2C_read(I2C_OPENCORES_0_BASE,1);
}

void write_it2(alt_u32 regaddr, alt_u8 data) {
	I2C_start(I2C_OPENCORES_0_BASE, IT_BASE, 0);
	I2C_write(I2C_OPENCORES_0_BASE, regaddr, 0);
...
BYTE I2C_Read_Byte(BYTE Addr,BYTE RegAddr) {
	I2C_start(I2C_OPENCORES_0_BASE, Addr, 0);
	I2C_write(I2C_OPENCORES_0_BASE, RegAddr, 0);
	I2C_start(I2C_OPENCORES_0_BASE, Addr, 1);
	return I2C_read(I2C_OPENCORES_0_BASE,1);
}
