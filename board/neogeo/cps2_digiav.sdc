...
create_clock -period 12MHz -name pclk [get_ports VCLK_in]
create_clock -period 2.67MHz -name bck [get_ports I2S_BCK]
...
set critinputs [get_ports {R_in* G_in* B_in* DARK_in SHADOW_in CSYNC_in}]
